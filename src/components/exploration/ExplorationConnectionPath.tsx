...
interface ExplorationConnectionPathProps {
  ...
  expandedTilePerLayer?: { [key: string]: 'custom-query' | null }
}
...
export const ExplorationConnectionPath: React.FC<ExplorationConnectionPathProps> = ({
  ...
  useEffect(() => {
    ...
    // Add a small delay to allow CSS transitions to complete when layout changes
  ...
  }, [showSubTiles, currentRootTileId, currentSubTileId, containerRef, activeTilePerLayer, visibleLayers, expandedTilePerLayer])
